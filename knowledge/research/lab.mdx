...
- specialized Rust neural-cell inference.
...
- train the smallest PyTorch baseline model that can beat a trivial baseline on
  held-out SPICE windows,
- export a first experimental `model.greybound.json` and
