...
model. The next acceptance-relevant work is to implement Rust inference and
compare the exported artifact against both SPICE holdouts and Greybound's current
