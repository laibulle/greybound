...
For the first VOX-family comparison, prefer an `Amp Head` NAM and pair it with
the same Greybound cabinet IR. Use `Full Rig / Combo` only as a fallback because
it includes cab/mic coloration and will make model-stage diagnosis less clean.
