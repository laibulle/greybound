...
```bash
target/release/greybound-cli --rig rigs/muffin-nox30.json5 --input-wav samples/teenager-electric-guitar-smooth-chords-dry_94bpm_G_major.wav --device 'DEVICE NAME' --output-channels 1,2 --sample-rate 44100 --period-size 16 --ir --monitor
```
...
```bash
target/release/greybound-cli --rig rigs/godess-one-nox30.json5 --input-wav samples/teenager-electric-guitar-smooth-chords-dry_94bpm_G_major.wav --output-wav target/greybound-godess-one-nox30-monitor.wav --render-seconds 10 --sample-rate 44100 --period-size 16 --ir --monitor
```

Dartford in the Nox30 FX loop rendered to a WAV file:

```bash
target/release/greybound-cli --rig rigs/dartford-nox30.json5 --input-wav samples/teenager-electric-guitar-smooth-chords-dry_94bpm_G_major.wav --output-wav target/greybound-dartford-nox30-monitor.wav --render-seconds 10 --sample-rate 44100 --period-size 16 --ir --monitor
```

Null output is useful when only the monitor log matters:

```bash
target/release/greybound-cli --rig rigs/nox30-driven.json5 --input-wav samples/teenager-electric-guitar-smooth-chords-dry_94bpm_G_major.wav --null-output --sample-rate 44100 --period-size 16 --ir --monitor
```
...
```bash
target/release/greybound-cli --rig rigs/nox30-driven.json5 --device 'DEVICE NAME' --input-channel 1 --output-channels 1,2 --sample-rate 44100 --period-size 16 --ir --monitor
```
