---
title: Architecture
description: How Greybound should separate DSP models, routing, shared electrical state, and monitor tooling.
---
...
See [Component Vocabulary](/architecture/component-vocabulary) for the canonical
distinction between physical parts, reusable circuit cells, model stages,
devices, and rigs. In short: a resistor or capacitor is a physical part; a
`first_stage` or `tone_stack` boundary is a stage-level contract.
