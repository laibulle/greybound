---
title: Muffin
description: Reverse-engineered Muffin engineering baseline for Boutique59 pedal modeling.
---
...
The current Boutique59 DSP approximation uses about 130 kOhm input impedance and about 10 kOhm output impedance. The modeling priority is to match electrical boundaries first, then stage transfer curves, then variant voicing.
