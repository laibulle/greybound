...
This promotion does not claim a new circuit-accuracy result. The model remains
the first-pass scalar approximation documented in the stage notes below and
still needs the component-level BJT/diode/tone-stack validation in the plan.
