---
title: Godess One
description: Reverse-engineered Godess One-style distortion engineering baseline for Boutique59 pedal modeling.
---

Godess One is Boutique59's first distortion pedal model. It targets a Godess One-style control surface: distortion, tone, level, and a Standard/Custom voicing switch. Standard mode keeps the tighter, brighter hard-clipped character; Custom mode adds more gain, body, and mid fill.
