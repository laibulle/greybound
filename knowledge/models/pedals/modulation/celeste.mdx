...
Celeste is Boutique59's first chorus model. The reference target is the classic Boss CE-2 family: musical analog chorus with a short BBD delay, slow LFO motion, rounded bandwidth, and a smooth wet/dry blend.
...
- Public BBD chorus schematics are used only as topology references. The source of truth for Boutique59 remains this model document plus the Rust implementation.
