...
Tron is Boutique59's optical-style phaser model. The reference target is the Mu-Tron Phasor II family: a 1970s phaser associated with organic lamp/LDR-style motion, rate/depth/feedback controls, and a smoother sweep than a sharper one-knob JFET phaser.
...
This is not a SPICE model and it is not component-exact. It is a musically useful phase network that gives Boutique59 a stable organic phaser while leaving room for future circuit-level validation.
