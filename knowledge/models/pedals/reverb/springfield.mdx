---
title: Springfield
description: Spring-tank-inspired reverb engineering baseline for Boutique59 FX-loop and chain modeling.
---

Springfield is Boutique59's first reverb model. It targets the musical behavior of a guitar spring reverb: a driven transducer feel, short metallic diffusion, bright splash, and a controllable wet/dry blend.
