---
title: Minotaur
description: Reverse-engineered Minotaur overdrive engineering baseline for Boutique59 pedal modeling.
---

Minotaur is Boutique59's first overdrive pedal model. It targets the broad behavior of buffered clean-blend overdrives: high input impedance, low output impedance, gain-dependent clipping, a treble/presence control, and enough headroom to push an amp without behaving like a fuzz.
