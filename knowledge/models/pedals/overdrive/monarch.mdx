---
title: Monarch
description: Reverse-engineered Monarch dual-stage overdrive engineering baseline for Greybound pedal modeling.
---
...
Monarch is available as a first-class pre-amp pedal in the Greybound Free
profile. Its default slot sits after Lumen and Muffin and before Minotaur, but
starts bypassed. This keeps the existing Free Minotaur preset and its gain
staging unchanged while making Monarch available as the heavier overdrive
option.

## Visual Identity

The Free faceplate is the project-owned `monarch@4x.png` render: a midnight
blue unframed enclosure with engraved Gain, Tone, and Output references, an
original crown-and-wings Monarch emblem, and side-mounted input/output jacks.
The knob caps, bypass LED, and footswitch remain dynamic UI controls.
