...
Nox30 is Boutique59's circuit-informed amp model. Its reference target is a JMI-era AC30/6 fitted with the OS/010 Top Boost unit. There is no single canonical circuit across all production years, so Boutique59 treats Nox30 as a chosen engineering target rather than a universal clone.
