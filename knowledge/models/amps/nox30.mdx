...
## Nox30 Stage Boundaries

Nox30 is structurally complete enough for stage-level replacement work. The model exposes boundaries for:
...
This telemetry is used by monitor logging and future graybox stage/cell training.
