...
- Verified a short WAV monitor render with `target/release/boutique59-cli --rig rigs/nox30-driven.json5 --input-wav samples/teenager-electric-guitar-smooth-chords-dry_94bpm_G_major.wav --output-wav target/boutique59-nox30-monitor.wav --render-seconds 2 --sample-rate 44100 --period-size 16 --ir --monitor`.
...
- Replaced rig-specific runtime examples with `target/release/boutique59-cli --rig ...` commands.
...
- Verified a short fuzz WAV render with `target/release/boutique59-cli --rig rigs/muffin-nox30.json5 --input-wav samples/teenager-electric-guitar-smooth-chords-dry_94bpm_G_major.wav --output-wav target/boutique59-fuzz-monitor.wav --render-seconds 2 --sample-rate 44100 --period-size 16 --ir --monitor`.
