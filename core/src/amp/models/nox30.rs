...
use crate::amp::{
    AmpControls, NeuralCellMode, Nox30OperatingPoint, StageBoundaryState, StageCoupling,
    StageSignal,
};
...
struct BoundaryRunner {
    last_boundaries: [StageBoundaryState; 11],
    tone_stack_input: StageSignal,
    params: Nox30BoundaryParams,
}
...
impl Nox30Current {
    ...
    pub(super) fn boundary_states(&self) -> [StageBoundaryState; 11] {
...
impl BoundaryRunner {
    fn from_operating_point(
        ...
        Self {
            ...
            tone_stack_input: StageSignal::new(
                0.0,
    ...
    fn process_tone_stack_boundary(
        ...
        self.tone_stack_input = StageSignal::new(
            follower_voltage_v,
    ...
    fn boundary_states(&self) -> [StageBoundaryState; 11] {
