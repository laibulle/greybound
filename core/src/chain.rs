    ...
    fn process_loaded_voltage(
        ...
        match self {
            ...
            Self::StudioDelay(pedal) => pedal.process_loaded_voltage(
                input_voltage,
                match controls {
                    DeviceControls::StudioDelay(controls) => controls,
                    DeviceControls::Default => StudioDelayControls::default(),
                    DeviceControls::Lumen(_) => StudioDelayControls::default(),
                    DeviceControls::Muon(_) => StudioDelayControls::default(),
                    DeviceControls::Muffin(_) => StudioDelayControls::default(),
                    DeviceControls::Minotaur(_) => StudioDelayControls::default(),
                    DeviceControls::Monarch(_) => StudioDelayControls::default(),
                    DeviceControls::GodessOne(_) => StudioDelayControls::default(),
                    DeviceControls::Dartford(_) => StudioDelayControls::default(),
                    DeviceControls::Tron(_) => StudioDelayControls::default(),
                    DeviceControls::Jetstream(_) => StudioDelayControls::default(),
...
mod tests {
    ...
    fn model_descriptors_define_distinct_visual_colors() {
        ...
        assert_eq!(amp_model_descriptor("lonestar-special").id, "none-star");
        assert_eq!(amp_model_descriptor("lone-star-special").id, "none-star");
        assert_eq!(
            amp_model_descriptor("boxer-seven-lead").label,
            "Boxer Seven Lead"
        );
        assert_eq!(
            amp_model_descriptor("shiva-20th-lead").id,
            "boxer-seven-lead"
        );
